...
public:
	...
	inline UINT32 flags() { return m_flags; }
...
public:
	...
	virtual ~handler_entry_read_new() {}
...
public:
	...
	virtual ~handler_entry_read_terminal_new() {}
...
public:
	...
	virtual ~handler_entry_write_terminal_new() {}
...
public:
	...
	virtual ~handler_entry_read_memory_new() {}

	virtual UINTX read(offs_t offset, UINTX mem_mask);
...
public:
	...
	virtual ~handler_entry_write_memory_new() {}

	virtual void write(offs_t offset, UINTX data, UINTX mem_mask);
...
public:
	...
	virtual ~handler_entry_read_single_new() {}
...
public:
	...
	virtual ~handler_entry_write_single_new() {}
...
public:
	...
	virtual ~handler_entry_read_multiple_new() {}
...
public:
	...
	virtual ~handler_entry_write_multiple_new() {}
...
public:
	...
	virtual ~handler_entry_read_dispatch_new() {}
...
public:
	...
	virtual ~handler_entry_write_dispatch_new() {}
...
template class handler_entry_read_dispatch_new<13,  1, 2, 0>;
template class handler_entry_read_dispatch_new<31, 14, 3, 0>;
template class handler_entry_read_dispatch_new<13,  1, 3, 0>;
template class handler_entry_read_dispatch_new<31, 14, 1, 1>;
template class handler_entry_read_dispatch_new<13,  1, 1, 1>;
...
template class handler_entry_read_dispatch_new<13,  1, 3, 1>;
template class handler_entry_read_dispatch_new<31, 14, 2, 2>;
template class handler_entry_read_dispatch_new<13,  1, 2, 2>;
...
template class handler_entry_read_dispatch_new<13,  1, 3, 3>;
...
template class handler_entry_write_dispatch_new<13,  1, 2, 0>;
template class handler_entry_write_dispatch_new<31, 14, 3, 0>;
template class handler_entry_write_dispatch_new<13,  1, 3, 0>;
template class handler_entry_write_dispatch_new<31, 14, 1, 1>;
template class handler_entry_write_dispatch_new<13,  1, 1, 1>;
...
template class handler_entry_write_dispatch_new<13,  1, 3, 1>;
template class handler_entry_write_dispatch_new<31, 14, 2, 2>;
template class handler_entry_write_dispatch_new<13,  1, 2, 2>;
...
template class handler_entry_write_dispatch_new<13,  1, 3, 3>;
