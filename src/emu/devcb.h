...
public:
	...
	devcb_base &set_space(std::string device, address_spacenum space = AS_0) { m_space_tag = device; m_space_num = space; return *this; }
	...
	{
	public:
		logger_desc(std::string string, UINT64 value = 0) { m_string = string; m_value = value; }
		std::string m_string;
		UINT64 m_value;
	};
