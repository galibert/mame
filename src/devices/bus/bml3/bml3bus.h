...
public:
	...
	static void static_set_bml3bus_slot(device_t &device, std::string tag, const char *slottag);
protected:
	// configuration
...
public:
	...
	// inline configuration
	static void static_set_bml3bus_tag(device_t &device, std::string tag, const char *slottag);
public:
