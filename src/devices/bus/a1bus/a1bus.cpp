...
void a1bus_slot_device::static_set_a1bus_slot(device_t &device, std::string tag, const char *slottag)
{
...
void device_a1bus_card_interface::static_set_a1bus_tag(device_t &device, std::string tag, const char *slottag)
{
