...
public:
	...
	static void static_set_a8sio_slot(device_t &device, std::string tag, const char *slottag);
...
public:
	...
	// inline configuration
	static void static_set_a8sio_tag(device_t &device, std::string tag, const char *slottag);
