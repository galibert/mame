...
void a8sio_slot_device::static_set_a8sio_slot(device_t &device, std::string tag, const char *slottag)
{
...
void device_a8sio_card_interface::static_set_a8sio_tag(device_t &device, std::string tag, const char *slottag)
{
