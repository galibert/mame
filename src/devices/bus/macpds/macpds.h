...
public:
	...
	static void static_set_macpds_slot(device_t &device, std::string tag, const char *slottag);
protected:
	// configuration
...
public:
	...
	// inline configuration
	static void static_set_macpds_tag(device_t &device, std::string tag, const char *slottag);
public:
